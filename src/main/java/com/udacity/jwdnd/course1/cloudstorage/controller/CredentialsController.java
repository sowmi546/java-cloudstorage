...
public class CredentialsController {
    ...
    @GetMapping
    public String getCredentialView(Authentication authentication, @ModelAttribute("credentialsForm") CredentialsForm credentialsForm, @ModelAttribute("noteForm") NoteForm noteForm, @ModelAttribute("files") Files files, Model model) {
